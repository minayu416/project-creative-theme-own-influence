      ...
      <div class="p-2">
        <div class="mx-auto flex flex-wrap bg-white">
          <div class="lg:w-2/3 w-full lg: h-full object-cover object-center bg-cover">
            ...
            <h3 class="font-bold">This place can put comment plugin.</h3>
...
async asyncData ({ params, $content }) {
    let postGet
    // console.log(params)
    // TODO Re-design the route or come up with new methods.
    const encoded = encodeURI(params.slug).toLowerCase();
    // console.log(encoded)
    postGet = await $content('posts').where({ slug: { $eq: encoded } }).fetch()
    // console.log(postGet)
