...
<MyOwnInfluenceHeader :image-url="require('~/static/img/img_8955.jpg')" />

  <!-- site content -->
  <div class="w-full h-full">
      <div class="site-branding-intro border-b border-solid motto-block">
        <!-- Center and be top and bottom -->
